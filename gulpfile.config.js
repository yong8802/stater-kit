...
const _dir = {
  ...
  copy: {
    ...
    jquery: {
      ...
      dest: _development + 'js/'
    },
    animate: {
      src: _bower + 'animate.css/animate.css',
      dest: _development + 'css/'
    },
    lib : {
      src: _source + 'js/lib/**/*.js',
      dest: _development + 'js/'
    }
  },
 ...
 */
const _BROWSERIFY = {
  entries: './src/js/script.js', // 번들 엔트리 파일 설정
